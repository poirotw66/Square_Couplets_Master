          ...
          <div className="mt-6 relative">
            {!referenceImage ? (
              ...
              <div className="relative group">
                <div className="relative w-full min-h-48 max-h-96 rounded-xl overflow-hidden border-2 border-amber-500/30 bg-red-950/20 flex items-center justify-center">
                  <img 
                    src={referenceImage} 
                    alt="Reference" 
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 p-2 bg-red-950/80 hover:bg-red-900/90 border border-amber-500/30 rounded-full text-amber-400 hover:text-amber-200 transition-all shadow-lg z-10"
                    disabled={status === GenerationStatus.PROCESSING_PROMPT || status === GenerationStatus.PROCESSING_IMAGE}
                  ...
                  <div className="absolute bottom-2 left-2 right-2 z-10">
                    <div className="flex items-center gap-2 text-xs text-amber-200/90 bg-black/60 px-2 py-1 rounded backdrop-blur-sm border border-amber-500/20">
